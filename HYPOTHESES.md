...
**Статус**: split — H6a rejected, H6b promising, требует walk-forward
(2026-09-07)
...
**Следующий шаг**: walk-forward для H6b на 1-2 самых убедительных
горизонтах (60 дней выглядит сильнее всего).
...
8. H6b — promising, требует walk-forward (DVOL-самодовольство → падения)

При 5 проверенных гипотезах, 1 "почти подтверждена" плюс 1 уточнение
с неоднозначным результатом — нормальное, не подозрительное соотношение.
