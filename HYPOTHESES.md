...
(классическая множественная проверка — см. заметку ниже), и у нас нет
содержательного объяснения, почему именно среда (не FOMC-дни, не
экспирация опционов на Deribit — та по пятницам). Статистика устойчивая
и кросс-активная, но отсутствие причинного механизма — веский повод для
осторожности. Не строим на этом торговых решений без независимого
подтверждения на будущих данных.
...
При 12 проверенных гипотезах — 6 отклонены (H1a, H1c, H2, H4, H6a, H7),
