...
**Результат** (`backtest_h3_dvol_filter.py`):

| Горизонт | Группа | n | Δ доходности | Δ частоты крупного роста |
|---|---|---|---|---|
| 90 дней | DVOL тоже в стрессе | 61 | **+9.92** | **+13.84 п.п.** |
| 90 дней | DVOL спокоен | 76 | +3.93 | +3.51 п.п. |
| 30 дней | DVOL тоже в стрессе | 61 | **−0.96** | **−12.06 п.п.** |
| 30 дней | DVOL спокоен | 76 | +4.56 | +5.13 п.п. |

**Вывод**: на 90 днях гипотеза подтверждается — эффект в 2-3 раза
сильнее, когда опционный рынок подтверждает стресс. На 30 днях —
разворот в противоположную сторону. Это уже третий случай (после H1a,
...
При 4 проверенных гипотезах, 1 "почти подтверждена" плюс 1 уточнение с
неоднозначным результатом — нормальное, не подозрительное соотношение.
Если из следующих 10 гипотез вдруг 8 окажутся "значимыми" — это повод
заподозрить ошибку в методологии, а не праздновать успех.
